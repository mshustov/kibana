...
export default async function ({ readConfigFile }) {
  ...
  const apiIntegrationConfig = await readConfigFile(require.resolve('../../api_integration/config'));
  ...
  return {
    ...
    services: apiIntegrationConfig.get('services'),
    servers: apiIntegrationConfig.get('servers'),
    junit: {
      reportName: 'Logging JSON Tests',
    },
    esTestCluster: apiIntegrationConfig.get('esTestCluster'),
    kbnTestServer: {
